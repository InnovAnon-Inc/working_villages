...
working_villages.require("jobs/sanddigger")
working_villages.require("jobs/dirtdigger")
working_villages.require("jobs/miner")
working_villages.require("jobs/bricklayer")
working_villages.require("jobs/dirtlayer")
